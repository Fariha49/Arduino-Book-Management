...
String Name1="9917013746";//first UID card
String Name2="491532838";//second UID card
...
void setup() {
  ...
  Serial.println("LABEL,ID,Date,ID,Book,Writer,Time IN,Time OUT,Name,Regitration,Session");// make four columns (Date,Time,[Name:"user name"]line 48 & 52,[Number:"user number"]line 49 & 53)
...
void loop() {
 ...
 //Serial.println(card_ID);//Uncomment this line to scan the card ID and appear it on Serial monitor.
       ...
       if(card_ID==Name1){
       Name="System Simulation";//user name
       Number=1802049;//user number
       ...
       Name="Amar Book";//user name
       Number=1802025;//user number
...
if(n==4){
    ExcelName +=L;
    L++;
    Serial.println("SAVEWORKBOOKAS,Books");
